...
// API configuration
const char* serverURL = "http://your-server-ip:5050/api/gps/fast"; // Using optimized API endpoint
const String deviceId = "ESP32-GPS-1"; // Unique identifier for this device
unsigned long lastSendTime = 0;
const int sendInterval = 5000; // Reduced interval: Send data every 5 seconds for faster updates
